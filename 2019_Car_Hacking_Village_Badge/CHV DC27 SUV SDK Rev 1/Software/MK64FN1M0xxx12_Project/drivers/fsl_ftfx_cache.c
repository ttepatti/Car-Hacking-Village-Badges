...
static const uint16_t s_ftfxCommonBitOperationFunctionCode[] = {
    ...
    0xd005u, /* BEQ.N @12 */
    0x6804u, /* LDR   R4, [R0] */
    0x438cu, /* BICS  R4, R4, R1 */
    0x4093u, /* LSLS  R3, R3, R2 */
    0x4019u, /* ANDS  R1, R1, R3 */
    0x4321u, /* ORRS  R1, R1, R4 */
    0x6001u, /* STR   R1, [R0] */
    /*  @12: */
    0xf3bfu, 0x8f6fu, /* ISB */
    0xf3bfu, 0x8f4fu, /* DSB */
...
static void ftfx_copy_common_bit_operation_to_ram(uint32_t *ftfxCommonBitOperation)
{
    ...
    memcpy(ftfxCommonBitOperation, (uint32_t *)(uint32_t)(&s_ftfxCommonBitOperationFunctionCode[0]),
...
void mcm_flash_cache_clear(ftfx_cache_config_t *config)
{
    ...
    callftfxCommonBitOperation_t callftfxCommonBitOperation = (callftfxCommonBitOperation_t)((uint32_t)config->comBitOperFuncAddr + 1U);
